...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-lattice-algo-compress-detail.ps1

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-lattice-algo-compress-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-lattice-algo-compress-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-lattice_algo_compress_stack-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
