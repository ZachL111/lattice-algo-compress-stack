"""Regression checks for the lattice-algo-compress-stack casebook."""
...
from casebook.harness import assert_expected, lattice_algo_compress_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(lattice_algo_compress_stack_summary(), assert_expected())
